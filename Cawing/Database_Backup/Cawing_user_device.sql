...
CREATE TABLE `user_device` (
  `UDID` varchar(200) NOT NULL DEFAULT '',
  `UID` char(40) NOT NULL DEFAULT '',
  `DeviceName` varchar(30) DEFAULT '',
  `DeviceClassify` varchar(30) NOT NULL DEFAULT '',
  `Enable` smallint(6) NOT NULL DEFAULT '1',
  PRIMARY KEY (`UDID`),
  KEY `UID_fk0_idx` (`UID`),
  CONSTRAINT `UID_fk0` FOREIGN KEY (`UID`) REFERENCES `user` (`UID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2014-01-30 20:34:29
